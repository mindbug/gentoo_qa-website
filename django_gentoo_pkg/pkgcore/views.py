...
# View is a web page in a Django application that serves a specific function and has a specific template.
# Each View is represented by a function, with the same name as referenced in urls.py.
